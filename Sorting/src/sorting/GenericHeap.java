...
public class GenericHeap<E extends Comparable<E>> {
	...
	public void maxHeapifyDefect() {
		for (int i = parent(heapSize); i >= 0; i--)
			maxHeapify(i);

	}
	public void maxHeapifyDefect(int i) {
		int l = left(i);
		int r = right(i);
		int largest = -1;
	...
	public String toString() {
		return "GenericHeap Size "+heapSize+" "+Arrays.toString(Arrays.copyOf(a, heapSize)) + " Rest: "+Arrays.toString(Arrays.copyOfRange(a,heapSize,a.length));
	}
